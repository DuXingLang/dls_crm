...
<center>
		...
		<%
			if(session.getAttribute("userName")!=null){
				//用户已登录 
		%>
			<form action="/dls_crm/Activity_noteServlet?method=save" method="post">
				<table width="80%" border="1">
					...
					<tr>
						...
						<td>
							<textarea name="activity" cols="70" rows="6">${note.getActivity() }</textarea>
						</td>
					</tr>
					<tr>
						<td colspan="2">
			...
			<h3>
				<a href="activity_notes.jsp">回到活动信息列表页面</a>
			</h3>		
	<%
			}else{
				//用户未登录，提示用户登录并跳转 
